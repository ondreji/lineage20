...
void ArtMethod::Invoke(Thread* self, uint32_t* args, uint32_t args_size, JValue* result,
  ...
  if ((result!=nullptr && result->GetI()==111111)&&!IsNative()){
	...
	if(LIKELY(code_item!=nullptr)){
	    if (IsStatic()) {
	        art::interpreter::EnterInterpreterFromInvoke(self, this, nullptr, args, result, /*stay_in_interpreter=*/ true);
	    }else{
	        art::interpreter::EnterInterpreterFromInvoke(self, this, nullptr, args + 1, result, /*stay_in_interpreter=*/ true);
	    }
